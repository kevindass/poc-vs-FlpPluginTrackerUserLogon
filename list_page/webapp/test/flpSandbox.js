		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comlbflptrackerlistpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlbflptrackerlistpage-display": {
								"semanticObject": "comlbflptrackerlistpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lb.flp.tracker.listpage",
									"url": sap.ui.require.toUrl("com/lb/flp/tracker/listpage")
								}
							}
						}
					}
